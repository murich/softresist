...
Кто мы:
- мы открыты к версиям и мнениям
- мы непредвзято и методично анализируем новости и заявления разных сторон, проверяя версии из многих источников
- мы против эскалации конфликта и войны с Россией (если уходить от украинства, то вместо этого "против межнациональных розней, конфликтов и войн между государствами")
- мы рады общаться как на Русском, так и на Украинском (если хочешь уйти от "украинства", тогда "мы готовы общаться на разных языках внутри страны") 
...
- если тебе не нравятся какие-то метрики сообщества то ты не кричишь фашисты/колорады/путин/обама а разбираешься как это - работает (нужно что-то вроде "исключение эмоционально окрашенных характеристик, недопущение оскорблений, перехода на личности")
- Безопасность:
